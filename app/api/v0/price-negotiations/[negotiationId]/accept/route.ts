// src/app/api/v0/price-negotiations/[negotiationId]/accept/route.ts
...
export async function POST(
  ...
  try {
    ...
    const acceptedNegotiation = await PriceNegotiationServerService.acceptNegotiation(
      negotiationId, 
      authToken
    );
    
    return NextResponse.json(acceptedNegotiation, { status: 200 });
