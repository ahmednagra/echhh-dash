// src/app/(dashboard)/@platform/b2c-clients/page.tsx
...
import { Search, Users, ChevronLeft, ChevronRight, UserCheck, UserX, Clock, Mail, Phone, Calendar, Briefcase, UserPlus, Edit, Trash2 } from 'react-feather';
...
interface User {
  ...
  campaign_count?: number; // Added campaign count field
}
...
export default function Companies() {
  ...
  const fetchUsers = useCallback(async () => {
    try {
      ...
      const params: UserSearchParams = {
        ...
        user_type: 'b2c', // Hardcoded to only fetch B2C users from companies
      };
      ...
      setError(err instanceof Error ? err.message : 'Failed to fetch B2C company clients');
      console.error('Error fetching B2C company clients:', err);
    } finally {
      setLoading(false);
    }
  ...
  const handleAddNewUser = () => {
    router.push('/create-user?type=b2c');
  };
  ...
  const handleDeleteUser = (userId: string) => {
    ...
    // You can show confirmation modal, then delete
  };
    ...
    <div className="p-4">
      <div className="max-w-full">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-700">Company B2C Clients</h2>
          <button
        ...
        {/* Users Table with proper overflow */}
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500 text-lg font-medium">No B2C company clients found</p>
                ...
                users.map((user) => {
                  ...
                  return (
                    <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      {/* Status Column - Clickable with Dropdown */}
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-500">
                            {user.campaign_count === 1 ? 'campaign' : 'campaigns'}
                          </span>
                        </div>
                      </td>
