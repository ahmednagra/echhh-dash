// src/app/(dashboard)/@platform/influencers/page.tsx
'use client';
...
export default function InfluencersPage() {
  ...
  const fetchUsers = useCallback(async () => {
    try {
      ...
      const params: UserSearchParams = {
        ...
        user_type: 'influencer', // Hardcoded to only fetch Influencers
      };
  ...
  const handleAddNewUser = () => {
    router.push('/create-user?type=influencer');
  };
    ...
    <div className="p-4">
      <div className="max-w-full">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-700">Influencers Management</h2>
          <button
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-12">
                    <div className="flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-gray-500 text-lg font-medium">No influencers found</p>
