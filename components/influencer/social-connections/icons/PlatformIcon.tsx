// =============================================================================
// src/components/influencer/social-connections/icons/PlatformIcon.tsx
// =============================================================================
// Platform-specific icon component with consistent sizing and styling
// =============================================================================
...
const PLATFORM_GRADIENTS: Record<SocialPlatformType, string> = {
...
export default function PlatformIcon({
  ...
  const renderIcon = () => {
    switch (platform) {
      ...
      case 'twitter':
        return <TwitterXIcon size={iconSize} />;
      case 'facebook':
  ...
  if (showBackground) {
    return (
      <div 
        className={`
          ${BACKGROUND_SIZES[size]} 
          ${PLATFORM_GRADIENTS[platform]} 
...
function TwitterXIcon({ size }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export { InstagramIcon, TikTokIcon, YouTubeIcon, TwitterXIcon, FacebookIcon };